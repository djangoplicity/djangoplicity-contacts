...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PostalZone'
        db.create_table('contacts_postalzone', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ))
        db.send_create_signal('contacts', ['PostalZone'])

        # Adding field 'Country.postal_zone'
        db.add_column('contacts_country', 'postal_zone', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contacts.PostalZone'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'PostalZone'
        db.delete_table('contacts_postalzone')

        # Deleting field 'Country.postal_zone'
        db.delete_column('contacts_country', 'postal_zone_id')
