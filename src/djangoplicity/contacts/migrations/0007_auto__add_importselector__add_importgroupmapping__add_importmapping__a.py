...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ImportSelector'
        db.create_table('contacts_importselector', (
            ...
            ('case_sensitive', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('contacts', ['ImportSelector'])

        # Adding model 'ImportGroupMapping'
        db.create_table('contacts_importgroupmapping', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('mapping', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contacts.ImportMapping'])),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contacts.ContactGroup'])),
        ))
        db.send_create_signal('contacts', ['ImportGroupMapping'])

        # Adding model 'ImportMapping'
        db.create_table('contacts_importmapping', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('template', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contacts.ImportTemplate'])),
            ('header', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('field', self.gf('django.db.models.fields.SlugField')(max_length=255, db_index=True)),
            ('group_separator', self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True)),
        ))
        db.send_create_signal('contacts', ['ImportMapping'])

        # Adding model 'ImportTemplate'
        db.create_table('contacts_importtemplate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
            ('duplicate_handling', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('multiple_duplicates', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('tag_import', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('contacts', ['ImportTemplate'])

        # Adding M2M table for field extra_groups on 'ImportTemplate'
        db.create_table('contacts_importtemplate_extra_groups', (
        ...
        db.create_unique('contacts_importtemplate_extra_groups', ['importtemplate_id', 'contactgroup_id'])


    def backwards(self, orm):
        
        # Deleting model 'ImportSelector'
        db.delete_table('contacts_importselector')

        # Deleting model 'ImportGroupMapping'
        db.delete_table('contacts_importgroupmapping')

        # Deleting model 'ImportMapping'
        db.delete_table('contacts_importmapping')

        # Deleting model 'ImportTemplate'
        db.delete_table('contacts_importtemplate')

        # Removing M2M table for field extra_groups on 'ImportTemplate'
        db.delete_table('contacts_importtemplate_extra_groups')
    ...
    models = {
        ...
        'contacts.importtemplate': {
            'Meta': {'object_name': 'ImportTemplate'},
