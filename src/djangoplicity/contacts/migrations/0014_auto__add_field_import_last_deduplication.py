...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Import.last_deduplication'
        db.add_column('contacts_import', 'last_deduplication',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Import.last_deduplication'
        db.delete_column('contacts_import', 'last_deduplication')
