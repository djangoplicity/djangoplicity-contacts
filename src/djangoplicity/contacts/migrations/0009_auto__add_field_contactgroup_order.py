...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ContactGroup.order'
        db.add_column('contacts_contactgroup', 'order', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ContactGroup.order'
        db.delete_column('contacts_contactgroup', 'order')
