...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Contact.group_order'
        db.add_column('contacts_contact', 'group_order', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Contact.group_order'
        db.delete_column('contacts_contact', 'group_order')
