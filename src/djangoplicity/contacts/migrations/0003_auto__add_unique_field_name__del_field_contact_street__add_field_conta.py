...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Field', fields ['name']
        db.create_unique('contacts_field', ['name'])

        # Rename field 'Contact.street'
        db.rename_column('contacts_contact', 'street', 'street_1')

        # Adding field 'Contact.street_2'
        db.add_column('contacts_contact', 'street_2', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Removing unique constraint on 'Field', fields ['name']
        db.delete_unique('contacts_field', ['name'])

        # Rename field 'Contact.street'
        db.rename_column('contacts_contact', 'street_1', 'street')

        # Deleting field 'Contact.street_2'
        db.delete_column('contacts_contact', 'street_2')
    ...
    models = {
        ...
        'contacts.contactgroup': {
            'Meta': {'ordering': "('category__name', 'name')", 'object_name': 'ContactGroup'},
