...
DJANGOPLICITY_CONTACT_ROOT = os.path.join(BASE_DIR, 'djangoplicity', 'contacts')
TMP_DIR = os.path.join(BASE_DIR, 'tmp')
SHARED_DIR = os.path.join(BASE_DIR, 'shared')


URLS_BASEPATH = os.environ.get('URLS_BASEPATH', 'public')
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            "{}/templates".format(DJANGOPLICITY_CONTACT_ROOT),
...
DATABASES = {
    'default': {
        ...
        'USER': 'djangoplicity-contacts',
        'PASSWORD': 'djangoplicity-contacts',
        'HOST': 'djangoplicity-contacts-db',
        'PORT': '5432',
    }
}
